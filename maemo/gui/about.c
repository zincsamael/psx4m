...
void about_dialog(GtkWindow* parent)
{
	...
	GtkWidget* logo = gtk_image_new_from_icon_name("psx4all",
		LOGO_ICON_SIZE);
	...
	GtkWidget* url_label = gtk_link_button_new("http://github.com/smokku/psx4all");
	GtkWidget* upstream_label = gtk_label_new("Credits: UNAI - ZODTTD - HLIDE - CHUI - TINNUS");
	GtkWidget* thanks_label = gtk_label_new("Banner image by nax3000.\nMany thanks to all of maemo.org for their help.");
